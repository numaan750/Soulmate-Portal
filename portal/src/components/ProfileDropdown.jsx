    ...
    <>
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="w-7 h-7 sm:w-9 sm:h-9 bg-[#AABFFF] cursor-pointer rounded-full flex items-center justify-center hover:bg-[#99AEFF] transition-all duration-200 shadow-lg"
        >
          ...
          <div className="absolute right-0 top-12 sm:top-14 w-[280px] sm:w-[300px] md:w-[320px] bg-black rounded-xl sm:rounded-2xl shadow-2xl border border-[#0A090C] shadow-md overflow-hidden z-50 animate-slideDown">
            <div className="p-2 sm:p-3 border-b border-[#ffffff40]">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#AABFFF] rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div className="py-1 sm:py-2">
              ...
              <Link
                href={
                  "https://apps.apple.com/us/app/soulmate-art-ai-drawing/id6752238846"
                }
                target="_blank"

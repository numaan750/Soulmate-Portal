...
const NameAnalysis = () => {
  ...
  const quickPrompts = [
    "What does my name reveal about my personality?",
    "Does my name affect my soulmate connection?",
    ...
    <div className="min-h-[400px] sm:min-h-[450px] lg:min-h-[550px] flex flex-col justify-between p-2 sm:p-0">
      <div className="text-[#FFFFFF] max-w-4xl flex flex-row items-start sm:items-center">
        ...
        <p className="leading-relaxed text-[14px] sm:text-[16px]">
          Your name holds powerful vibrations — let’s decode what it says about
          you.”
        </p>
      </div>
      ...
      <div className="space-y-3 sm:space-y-4">
        ...
        <div className="flex items-center bg-[#2A2D3A] rounded-full px-3 sm:px-4 py-3 sm:py-4">
          <input
            ...
            className="flex-1 bg-transparent cursor-pointer text-gray-300 outline-none placeholder-gray-500 text-[12px] sm:text-[14px] md:text-[16px]"
          />
          <Image
            src={
              input.trim()
